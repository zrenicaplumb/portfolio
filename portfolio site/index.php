...
?>
	<div class="wrap">
		<header>
			<a href="index.php"><img src="myLogo.png" alt="logo" id="logo"></a>
			<nav>
				<ul>
		...
		<div class="content">	
			...
			<div class="work-div" name="work">
				...
				<div class="row">
					...
					<a href="http://www.arsc-audio.org/index.php"><img src="">Association for Recorded Sound Collections (ARSC)</a>
					<a href="http://financialripple.com/"><img src="">Ripple</a>
					<a href=""><img src=""></a>
					<a href=""><img src=""></a>
					<a href=""><img src=""></a>
					...
					<div class="UVU">
						<a href="https://www.uvu.edu/is/">Integrated Studies</a>
						<a href="https://www.uvu.edu/lang/index.html">Languages Program</a>
						<a href="https://www.uvu.edu/idst/contours/#">Interdisciplinary Studies Home Page</a>
			...
			<div class="about-div">
				...
				<p>I am an aspiring Web Designer and Developer, graduating in May with a bachelor's in Web Design &amp; Development at UVU with an emphasis in Application Development. I thoroughly enjoy coding and learning about all things web-related. I enjoy human languages and speak English and Polish fluently and have studied Russian, Spanish, Japanese, am an archaic-language dilettante, and am currently creating my own language. I like to think this skill of mine crosses over into the realm of coding languages also. </p>
				...
				<p>When i'm not working on web stuff, I write music on the piano, read, run, and learn. I love accumulating knowledge that helps me to understand this amazing universe and humanity on a deeper and more fundamental level.</p>
